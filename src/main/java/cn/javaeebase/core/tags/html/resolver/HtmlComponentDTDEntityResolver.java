package cn.javaeebase.core.tags.html.resolver;
...
public class HtmlComponentDTDEntityResolver implements EntityResolver, Serializable {
	...
	private static final String HOP_DYNAMIC_STATEMENT = "http://www.javaeebase.cn/dtd/";
	...
	public InputSource resolveEntity(String publicId, String systemId) {
		...
		if (systemId != null) {
			...
			if (systemId.startsWith(HOP_DYNAMIC_STATEMENT)) {
				LOGGER.debug(
						"recognized hop html component namespace attempting to resolve on classpath under cn/javaeebase/core/tags/html/dtd/");
	...
	private InputSource resolveOnClassPath(String publicId, String systemId, String namespace) {
		...
		String path = "cn/javaeebase/core/tags/html/dtd/" + systemId.substring(namespace.length());
