...
import cn.javaeebase.core.disruptor.sms.SmsEvent.SmsHandlerCallBack;
import cn.javaeebase.core.disruptor.sms.SmsHelper;
...
import cn.javaeebase.modules.sms.service.ISmsSendService;
...
public class SmsSendServiceImpl implements ISmsSendService {
	...
	public void sendAsyncSmsByCode(String phone, String code, SmsHandlerCallBack callBack, String... datas) {
		...
		cn.javaeebase.core.utils.sms.data.SmsTemplate template = cn.javaeebase.core.utils.sms.data.SmsTemplate.newTemplate(templateId, templateContent);
	...
	public void sendAsyncSmsByContent(String phone, String content, SmsHandlerCallBack callBack, String... datas) {
		cn.javaeebase.core.utils.sms.data.SmsTemplate template = cn.javaeebase.core.utils.sms.data.SmsTemplate.newTemplateByContent(content);
		SpringContextHolder.getBean(SmsHelper.class).sendAsyncSms(phone, template, callBack, datas);
	}
