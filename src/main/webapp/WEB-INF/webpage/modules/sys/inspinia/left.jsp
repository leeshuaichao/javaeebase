	...
	<li class="nav-header">
		<div class="dropdown profile-element">
			...
			<ul class="dropdown-menu animated fadeInRight m-t-xs">
				...
				<li style="display:none;"><a  href="#" onclick=" openDialog(title,url,gridId,width, height);update('修改密码','/javaeebase/admin/sys/user/changePassword','userGridId','800px','500px')">修改密码</a></li>
				<li class="divider"></li>
